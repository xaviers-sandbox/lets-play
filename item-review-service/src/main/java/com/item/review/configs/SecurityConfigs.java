...
public class SecurityConfigs {
	...
	private static final String[] WHITE_LIST = { "/hello", "/hello/**", "/webjars", "/webjars/**", "/actuator",
			"/actuator/**", "/api-docs", "/api-docs/**", "/swagger-ui.html", "/swagger-ui.html/**", "/swagger-ui/**" };

	private static final String[] BLACK_LIST = { "/v1/item-reviews/app", "/v1/item-reviews/app",
			"/v1/item-reviews/app/**", "/v1/item-reviews/dbs", "/v1/item-reviews/dbs/**", "/v1/item-reviews/caches",
			"/v1/item-reviews/caches/**" };
